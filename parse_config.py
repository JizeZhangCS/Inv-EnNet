...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None, training=True):
        ...
        :param config: Dict containing configurations, hyperparameters for training.
                       Contents of `./config/default.json` file for example.
        ...
        if training:
            ...
            self._save_dir = self._log_dir = save_dir / 'test' / exper_name / run_id
    ...
    def from_args(cls, args, training=True, options=''):
        ...
        if args.resume is not None:
            ...
            msg_no_cfg = "Configuration file need to be specified. Add '-c ./config/default.json', for example."
    ...
    def get(self, name):
        """Get items like ordinary dict, robust to non-existing config."""
