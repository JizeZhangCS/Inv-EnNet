...
def define_D(input_nc=3, ndf=64, n_layers_D=3, use_sigmoid=False, device=torch.device("cuda")):
    netD = NoNormDiscriminator(input_nc, ndf, n_layers=n_layers_D, use_sigmoid=use_sigmoid)
    netD = netD.to(device)
